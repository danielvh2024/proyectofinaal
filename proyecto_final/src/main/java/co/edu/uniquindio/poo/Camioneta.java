...
public class Camioneta extends Vehiculo{
    ...
    public Camioneta(String marca, String usadoONuevo, String modelo, int velocidadMaxima, String tipoCombustible,
    ...
    public String toString() {
        return negrita+naranja+"Camioneta con las siguientes caracteristicas:\n"+reset+naranja+super.toString()+ ", numero de pasajeros: " + numeroPasajeros + ", numero de puertas: " + numeroPuertas
                ...
                + ", tiene sensor de colision?: " + sensorColision + ", es 4x4?: " + es4x4+reset;
    }
